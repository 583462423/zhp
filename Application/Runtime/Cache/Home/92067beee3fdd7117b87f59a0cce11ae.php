  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="header-nav">
	 ...
	 <ul class="nav navbar-nav right-nav">
        <li class="active"><a href="<?php echo U('Home/Manager/havepass');?>">已通过物品</a></li>
        <li><a href="<?php echo U('Home/Manager/manager');?>">未通过物品</a></li>
      </ul>
			...
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="col-md-3" style="text-align: center;margin-top:20px;">
					<form action="<?php echo U('Home/Manager/pass');?>" id="subForm" style="border:1px solid #ccc;padding:10px 0">
							...
							<div class="input-group cost col-xs-offset-1 col-xs-10" style="margin-top:10px">
								<a href = "<?php echo U('Home/Manager/pass_delete');?>?id=<?php echo ($vo["goodsid"]); ?>" class="btn btn-primary col-xs-4">删除</a>
								<a href="<?php echo U('Home/Des/des');?>?id=<?php echo ($vo["goodsid"]); ?>" class="btn btn-info col-xs-offset-4 col-xs-4">详情</a>
							</div>
					</form>
