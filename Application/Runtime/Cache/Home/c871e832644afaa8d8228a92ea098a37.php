...
<nav class="navbar navbar-inverse navbar-fixed-top">
  <div class="container">
	...
	<div class="container">
		...
		<p style="text-align:right"><b>作者</b>:<?php echo ($list["goodsowner"]); ?> | <b>Tel</b>:<?php echo ($list["phone"]); ?></p>
		<img class="img-thumbnail" src="/Public/GoodsImgs/<?php echo ($list["goodssavename"]); ?>" style="float:left;width:200px;height:200px">		
		<?php echo ($list["goodsdes"]); ?>
	</div>
